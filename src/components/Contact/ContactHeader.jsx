...
import ContactHeaderimage from "../../assets/images/contactHeader.jpg";
export const ContactHeader = () => {
  return (
    <section className="lg:px-0 px-2">
      <img src={ContactHeaderimage} className="w-full" />
      <div className="text-center md:max-w-7xl max-w-8xl mx-auto py-6 text-[#828282]">
        <p>
