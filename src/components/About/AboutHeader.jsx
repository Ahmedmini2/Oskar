...
import AboutHeaderimage from "../../assets/images/aboutHeader.jpg";
export const AboutHeader = () => {
  return (
    <section className="lg:px-0 px-2">
      <img src={AboutHeaderimage} className="w-full" />
      <div className="text-center md:max-w-7xl max-w-8lg mx-auto py-6 text-[#828282]">
        <p>
